...
for test_case in $ROOT/tests/benchamarks/*; do
	...
	#let "total_tests=total_tests+1"
        ...
        echo -e "[$test_case] Generating Hierarchical QASMe"
	...
	#let "total_tests=total_tests+1"
        ...
        echo -e "[$test_case] Generating Flattened QASM"
...
#let "total_tests=total_tests+1"
        ...
        echo -e "[$test_case] Generating OpenQasm"
